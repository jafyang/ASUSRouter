...
install_now(){
	# default value
	local TITLE="Lighttpd"
	local DESCR="轻量化的Web服务器"
	...
	chmod 666 /koolshare/configs/lighttpd/lighttpd.log >/dev/null 2>&1
	chmod 666 /koolshare/configs/lighttpd/lighttpd.pid >/dev/null 2>&1
