	...
	<head>
		...
		<script>
			...
			var params = {
				enable: "nginx_enable",
				version: "nginx_core",
				htpversion: "nginx_htpcore",
				phpversion: "nginx_phpcore",
				status: "nginx_status",
				port: "nginx_port",
				watchdog: "nginx_watchdog",
				firewall: "nginx_firewall"
			}
			...
			function get_dbus_data() {
				$.ajax({
					...
					success: function (data) {
						...
						//E(params.version).innerHTML = (dbus[params.htpversion] && dbus[params.phpversion]) ? dbus[params.htpversion] + "<br>" +dbus[params.phpversion] : "*";
						...
						E(params.port).innerHTML = (!dbus[params.port] || dbus[params.port] === "") ? "无" : dbus[params.port].split(",").map(p => {
							return `<a target="_blank" href="http://<% nvram_get("lan_ipaddr"); %>:${p}/php/index.php" title="IPv4访问测试"><em>${p}</em></a>`;
						}).join("&nbsp;&nbsp;");
			...
			function save() {
				...
				var postData = { "id": id, "method": "nginx_config.sh", "params": [1], "fields": new_dbus };
			...
			function menu_hook() {
				tabtitle[tabtitle.length - 1] = new Array("", "nginx");
				tablink[tablink.length - 1] = new Array("", "Module_nginx.asp");
			}
									...
									<table class="FormTitle" width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3">
										<tr>
											<td bgcolor="#4D595D" colspan="3" valign="top">
												<div>&nbsp;</div>
												<div class="formfonttitle" style="float:left;">Nginx</div>
												...
												<div style="margin-left:5px;">
													<li><a target="_blank" href="https://nginx.org/" title="跳转到Nginx官网"><em><u>Nginx</u></em></a>是一款高性能HTTP和反向代理Web服务器，搭配<a target="_blank" href="https://www.php.net/" title="跳转到PHP官网"><em><u>PHP</u></em></a>实现动态网页服务。</li>
												</div>
												<div style="margin:5px 0px 0px 0px;">
													<table class="FormTable" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3">
														...
														<tr id="switch_tr">
															...
															<td colspan="2">
																<div class="switch_field" style="display:table-cell">
																	<label for="nginx_enable">
																		<input id="nginx_enable" class="switch" type="checkbox" style="display:none;" />
														...
														<tr id="core_version" style="display:none;">
															<th style="cursor:help;" title="内核发行版本号">内核版本</th>
															<td>
																<span id="nginx_core"></span>
															</td>
														</tr>
														<tr id="last_status" style="display:none;">
															<th>运行状态</th>
															<td>
																<span id="nginx_status"></span>
															</td>
														</tr>
														<tr id="listen_port" style="display:none;">
															<th>监听端口</th>
															<td>
																<span id="nginx_port"></span>
															</td>
														</tr>
														<tr id="svr_restart" style="display:none;">
															<th style="cursor:help;" title="当设备重启或断开时允许强制启动服务">服务进程守护</th>
															<td>
																<input type="checkbox" id="nginx_watchdog" style="vertical-align:middle;" />
															</td>
														</tr>
														<tr id="svr_firewall" style="display:none;">
															<th style="cursor:help;" title="允许外部访问可能会导致被黑客攻击">外部访问<em>(谨慎)</em></th>
															<td>
																<input type="checkbox" id="nginx_firewall" style="vertical-align:middle;cursor:help;" title="允许外部访问可能会导致被黑客攻击" />
															</td>
														</tr>
														<tr id="info_config" style="display:none;">
															<th style="cursor:help;" title="请使用SSH或WinSCP登录修改配置文件后重新提交">配置路径</th>
															<td>
																<span><em>Nginx: /opt/etc/nginx/nginx.conf</em><br><em>PHP: /opt/etc/php8-fpm.ini</em><br><em>Html: /opt/etc/www/</em></span>
															</td>
														</tr>
													</table>
												</div>
